				...
				<div class="container rounded bg-white">
					...
					<div class="p-3 py-5">
						<div
							...
							<h1 class="text-right">UPDATE BILLING</h1>
						</div>
						<form action="BillController" method="post">
						<input type="hidden" name="userid" value="<%= sessionId %>">
							<div class="col-md-12">
								<label class="labels">BILL ID</label><input type="text"
									class="form-control" id="bid" name="bid"
									value="<c:out value="${bill.bid}"/>" readonly>
							</div>
							<div class="col-md-12">
								<label class="labels">BILL NAME</label><input type="text"
									class="form-control" id="billbane" name="billname"
									value="<c:out value="${bill.billname}"/>">
							</div>
							<div class="col-md-12">
								<label class="labels">DATE</label><input type="date"
									class="form-control" id="date" name="date"
									value="<c:out value="${bill.date}"/>">
							</div>
							<div class="col-md-12">
								<label class="labels">AMOUNT</label><input type="text"
									class="form-control" id="amount" name="amount"
									value="<c:out value="${bill.amount}"/>">
							</div>
							<br> <input class="btn btn-primary" type="submit"
								value="UPDATE BILLING"> <input type="reset"
